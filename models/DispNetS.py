...
class DispNetS(nn.Module):
    ...
    def __init__(self, alpha=10, beta=0.01):
        ...
        ##Conv the correspongding two planes into one final one planes as output depth map!
    ...
    def forward(self, x):
        ...
        if self.training:
            return disp1, disp2, disp3, disp4                            ###--if training, return disp1, disp2, disp3, disp4, canbe using only disp1 to train with monodepth, or 4 scales! 
        else:
            return disp1
