...
def read_scene_data(data_root, test_list, seq_length=3, step=1):
    ...
    for sample in tqdm(test_list):
        ...
        scene_length = len(tgt_img_path.parent.files('*.jpg'))
        ...
        ref_imgs_path = [tgt_img_path.dirname()/'{:010d}.jpg'.format(i) for i in ref_indices]
        ...
        if tgt_img_path.isfile():
            ...
            displacements.append(get_displacements(data_root/date/
            scene/'oxts', ref_indices, demi_length))
        else:
