##############################--------prepare_train_data.py is to adjust the raw data to our format, should run this file before all the steps at the very beginning !!!!!!
...
def transform_from_rot_trans(R, t):
    ...
    R = R.reshape(3, 3)
    t = t.reshape(3, 1)
    return np.vstack((np.hstack([R, t]), [0, 0, 0, 1]))              #####--------------------this will return a standard SE(3)  T=[R,t; 0',1]
...
class KittiRawLoader(object):
    ...
    def collect_train_folders(self):
        ...
        for date in self.date_list:
            drive_set = (self.dataset_dir/date).dirs() ######---------------------------here KITTI_RAW_DATA/2011_09_26 
            for dr in drive_set:
